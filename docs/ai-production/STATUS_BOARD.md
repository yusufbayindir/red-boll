...
Sprint 01 technical debt note: source of truth is `docs/ai-production/technical-debt/TECHNICAL_DEBT_REGISTER.md`; TASK-0016 references existing TD-0001 through TD-0008 where relevant. Dashboard roster/state sync is still manual and remains covered by TD-0007 and TD-0008. TASK-0027 updated TD-0012 closure criteria but added no new debt ID. Post-PlayMode dashboard sync added no new debt ID.
