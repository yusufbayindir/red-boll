...
TASK-0037 created the following original runtime UI assets locally with Python 3 and Pillow. These are project-owned programmatic raster assets, not third-party downloads and not AI model outputs. Unity `.meta` files are present beside every PNG.

| Asset ID | Asset | Tool / creator | Generation date | Runtime path | Metadata | Runtime use | Review status | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `RB-PROG-20260512-009` | Primary button skin | Codex Modern UI Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint03/button_primary.png` | PNG, 420x112, SHA-256 `14931c4f15b6efae5e3653660f188620f1ac19d18f60aa27aebab57fd06c2513` | Main menu primary CTA and jump-control plate. | Runtime integrated; Unity import/compile PASS; EditMode 20/20 PASS; PlayMode 5/5 PASS | Fallback: existing UI `buttonA` sprite. |
| `RB-PROG-20260512-010` | Secondary button skin | Codex Modern UI Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint03/button_secondary.png` | PNG, 420x112, SHA-256 `cdc2d30962442f58339f5f97e0ce1a3ab72e0a0ef43ee12d99cd8671fac51d44` | Secondary CTA, back button, and touch-control plate. | Runtime integrated; Unity import/compile PASS; EditMode 20/20 PASS; PlayMode 5/5 PASS | Fallback: existing UI `pause` sprite. |
| `RB-PROG-20260512-011` | Feature chip skin | Codex Modern UI Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint03/feature_chip.png` | PNG, 360x82, SHA-256 `db94be45b0ea8107ba3a24710a1745f1dfb63bbecbe5e2ef1a1391a5f0988852` | Main-menu feature chips and level-select legend panel. | Runtime integrated; Unity import/compile PASS; EditMode 20/20 PASS; PlayMode 5/5 PASS | Fallback: existing RedBall `tile_grey` sprite. |
| `RB-PROG-20260512-012` | HUD panel skin | Codex Modern UI Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint03/hud_panel.png` | PNG, 980x92, SHA-256 `436469c932a2c352402f3b86be6901caec3c891877dcbcbb02651b7499b3d300` | Compact gameplay top HUD panel. | Runtime integrated; Unity import/compile PASS; EditMode 20/20 PASS; PlayMode 5/5 PASS | Fallback: existing RedBall `tile_grey` sprite. |
| `RB-PROG-20260512-013` | Language chip skin | Codex Modern UI Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint03/language_chip.png` | PNG, 300x78, SHA-256 `7f23436f61f3400fb4742b94ecafd3f8fa10ca5d9624c29ba97f1d103136e224` | Runtime language selector buttons. | Runtime integrated; Unity import/compile PASS; EditMode 20/20 PASS; PlayMode 5/5 PASS | Fallback: existing RedBall `tile_grey` sprite. |
| `RB-PROG-20260512-014` | Level card skin | Codex Modern UI Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint03/level_card.png` | PNG, 300x172, SHA-256 `8096898d7b4633624645a548ffc3e3aefdc3895f50458524d2e82e5aacd802af` | Level-select card buttons and locked/available/completed states. | Runtime integrated; Unity import/compile PASS; EditMode 20/20 PASS; PlayMode 5/5 PASS | Fallback: existing RedBall `tile_grey` sprite. |
| `RB-PROG-20260512-015` | Glass panel skin | Codex Modern UI Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint03/panel_glass.png` | PNG, 900x520, SHA-256 `13297294f6370dd2bdda7ca116a881e31d1543268079ee91f8aa90e50310f5a3` | Main-menu premium card panel. | Runtime integrated; Unity import/compile PASS; EditMode 20/20 PASS; PlayMode 5/5 PASS | Fallback: existing RedBall `tile_grey` sprite. |

TASK-0037 Sprint04 added the following original gameplay/decor polish assets locally with Python 3 and Pillow. These are project-owned programmatic raster assets, not third-party downloads and not AI model outputs. Unity `.meta` files are present beside every PNG.

| Asset ID | Asset | Tool / creator | Generation date | Runtime path | Metadata | Runtime use | Review status | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `RB-PROG-20260512-016` | Parallax hills band | Codex Runtime Polish Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint04/parallax_hills.png` | PNG, 2048x512, 25,197 bytes, SHA-256 `9bfc26968706b11b2408b571599b7b64a1d8044f2577a25108f8dad071436d53` | Non-colliding background band used by `AddSkyDressing` in every existing level. | Runtime integrated; Unity import/compile PASS; EditMode 22/22 PASS; PlayMode 5/5 PASS | Fallback: existing RedBall `tile_background_grass` sprite. |
| `RB-PROG-20260512-017` | Route arrow glow | Codex Runtime Polish Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint04/route_arrow.png` | PNG, 256x128, 2,038 bytes, SHA-256 `4225ad84ed40a10dad6dfaa565c32d20fde946d11391d7ebfeb6522d7f2654be` | Non-colliding route marker paired with existing route sparkle markers, including Level 14 and Level 15. | Runtime integrated; Unity import/compile PASS; EditMode 22/22 PASS; PlayMode 5/5 PASS | Fallback: Sprint02 `dust_sparkle` sprite. |
| `RB-PROG-20260512-018` | Hazard floor glow | Codex Runtime Polish Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint04/hazard_floor_glow.png` | PNG, 384x96, 2,893 bytes, SHA-256 `22fa308cc2e7cbf71cf0555f38985085e4395d314ef2be38fb3b6eaba7b0c28d` | Non-colliding glow under warning-sign hazard areas. | Runtime integrated; Unity import/compile PASS; EditMode 22/22 PASS; PlayMode 5/5 PASS | Fallback: Sprint02 `warning_spark` sprite. |
| `RB-PROG-20260512-019` | Goal halo | Codex Runtime Polish Developer using Pillow | 2026-05-12 | `Assets/Resources/Generated/Sprint04/goal_halo.png` | PNG, 256x256, 16,299 bytes, SHA-256 `7175de75306dea3f4c0deba9b14e61039d999d5f047341682e4ee3f90695a11b` | Non-colliding halo behind every goal object. | Runtime integrated; Unity import/compile PASS; EditMode 22/22 PASS; PlayMode 5/5 PASS | Fallback: existing UI `flag` sprite. |
